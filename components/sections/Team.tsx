    ...
    <section id="team" className="relative bg-white py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <div className="mt-10 grid grid-cols-1 gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            {teams.map((t, i) => (
              <Reveal key={t.name} delay={i * 80}>
                <div className="group h-full rounded-2xl border border-ink/10 bg-mist p-6 transition hover:-translate-y-1 hover:bg-white hover:shadow-card">
          ...
          <Reveal delay={120}>
            <div className="relative h-full overflow-hidden rounded-2xl bg-navy-900 p-7">
                ...
                <div className="mt-6 space-y-5">
                  {operations.map((o) => (
                    <div key={o.title} className="flex gap-4">
                      <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-white/5 text-brand">
