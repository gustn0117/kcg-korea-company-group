  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <Reveal>
          <div className="mt-10 grid grid-cols-1 gap-2 rounded-3xl border border-white/10 bg-navy-800/50 p-2 sm:grid-cols-3">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {industries.map((it, i) => (
            <Reveal key={it.title} delay={(i % 4) * 80}>
              <div className="group flex h-full items-center gap-4 rounded-2xl border border-white/10 bg-navy-800/50 p-5 transition hover:-translate-y-1 hover:border-brand/30 hover:bg-navy-800">
                <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-white/5 text-brand transition group-hover:bg-brand/15">
